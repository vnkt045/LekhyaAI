...
export default function AccountsInfoPage() {
    const router = useRouter();

    const menuItems: { label: string; path: string; key: string; disabled?: boolean }[] = [
        { label: 'Groups', path: '/masters/group', key: 'G' },
        { label: 'Ledgers', path: '/masters/ledger', key: 'L' },
        { label: 'Cost Centers', path: '/masters/cost-centers', key: 'C' },
        { label: 'Voucher Types', path: '/masters/voucher-types', key: 'V' },
        ...
        <div className="flex flex-col h-screen bg-lekhya-base">
            <div className="lekhya-header z-10">
                <div className="flex items-center gap-4">
                    <h1 className="font-bold text-lg tracking-wide pl-2">LekhyaAI <span className="text-gray-400 text-sm font-normal">/ Masters / Accounts Info</span></h1>
                </div>
            </div>
