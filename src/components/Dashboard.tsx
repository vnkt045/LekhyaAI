                    ...
                    <div className="max-w-5xl mx-auto space-y-8">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                ...
                                <Link href="/masters/godowns" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    ...
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Godowns</span>
                                </Link>
                                <Link href="/masters/cost-centers" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    ...
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Cost Centers</span>
                                </Link>
                                <Link href="/masters/currencies" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    <div className="w-12 h-12 rounded-full bg-lime-50 flex items-center justify-center group-hover:bg-lime-100 transition-colors">
                                        <svg className="w-6 h-6 text-lime-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Currencies</span>
                                </Link>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                ...
                                <Link href="/vouchers/new?type=Journal" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    ...
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Journal Entry</span>
                                </Link>
                                <Link href="/vouchers/new?type=Contra" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    ...
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Contra Entry</span>
                                </Link>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                ...
                                <Link href="/settings/audit-logs" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    ...
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Audit Logs</span>
                                </Link>
                            </div>
                        </section>
                        ...
                        {/* Banking Section */}
                        <section>
                            <h3 className="text-lekhya-text text-sm font-bold uppercase mb-4 tracking-wider">Banking</h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                <Link href="/banking" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                                        <svg className="w-6 h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                        </svg>
                                    </div>
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Bank Accounts</span>
                                </Link>
                                <Link href="/banking/reconciliation" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    <div className="w-12 h-12 rounded-full bg-teal-50 flex items-center justify-center group-hover:bg-teal-100 transition-colors">
                                        <svg className="w-6 h-6 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                                        </svg>
                                    </div>
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Reconciliation</span>
                                </Link>
                                <Link href="/banking/pdc" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    <div className="w-12 h-12 rounded-full bg-indigo-50 flex items-center justify-center group-hover:bg-indigo-100 transition-colors">
                                        <svg className="w-6 h-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                    </div>
                                    <span className="text-sm font-semibold text-lekhya-dark text-center">Post-Dated Cheques</span>
                                </Link>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                ...
                                <Link href="/settings/users" className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-lekhya-primary/20 hover:scale-[1.02] transition-all flex flex-col items-center gap-3 group">
                                    <div className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center group-hover:bg-gray-100 transition-colors">
                                        <svg className="w-6 h-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
